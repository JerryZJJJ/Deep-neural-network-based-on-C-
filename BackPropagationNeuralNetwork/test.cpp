...
int main()
{
	...
	MatrixXd train_x = load_csv<MatrixXd>("CatData\\train_x.csv");
	MatrixXd train_y = load_csv<MatrixXd>("CatData\\train_y.csv");
	MatrixXd test_x = load_csv<MatrixXd>("CatData\\test_x.csv");
	MatrixXd test_y = load_csv<MatrixXd>("CatData\\test_y.csv");
	...
	//map<string, MatrixXd> parameters;
	//two_layer_model(train_x, train_y, layers_dims, 0.0075, 2400, true, parameters);
	//MatrixXd prediction;
